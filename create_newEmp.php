                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td style='font-size: 14px;'> 
                                                <a href='./update_emp.php?edit_id=" . $row['emp_id'] . "' name='btn_edit' class='text-primary'><i class='fa-solid fa-pen-to-square'></i></a>
                                                <a href='#' class='text-danger' data-bs-toggle='modal' data-bs-target='#modal_" . $row['emp_id'] . "'>
                                        ...
                                        echo "<div class='modal fade' id='modal_" . $row['emp_id'] . "' tabindex='-1' aria-labelledby='modalLabel_" . $row['emp_id'] . "' aria-hidden='true'>";
                                        echo "<div class='modal-dialog'>";
                                        echo "<div class='modal-content'>";
                                        echo "<div class='modal-header'>";
                                        echo "<h1 class='modal-title text-danger' id='modalLabel_" . $row['emp_id'] . "' style='font-size: 16px;'><i class='fa-solid fa-trash'></i> <span>Are you sure?</span></h1>";
                                        echo "<button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>";
                                        echo "</div>";
                                        echo "<div class='modal-body'>";
                                        echo "<p style='font-size: 14px;'>If you delete this employee, all their data will be permanently removed from the system. This action cannot be undone.</p>";
                                        echo "</div>";
                                        ...
                                        echo "<button type='submit' class='btn btn-primary' name='btn_delete'>Yes</a>";
                                        echo "</form>";
                                        echo "</div>";
                                        echo "</div>";
                                        echo "</div>";
